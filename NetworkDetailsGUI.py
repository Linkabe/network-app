...
Label(f5, text="Enter an IP Address or Blank For Local DNS:", font=("Arial", 9)).place(x=438, y=237)
Label(f5, text="Eg:", font=("Arial", 9)).place(x=445, y=131)
e1 = Entry(f5, width=30)
e1.insert(0, '8.8.8.8')
e1.place(x=470, y=133)
Label(f5, text="Eg:", font=("Arial", 9)).place(x=445, y=201)
e2 = Entry(f5, width=30)
e2.insert(0, '8.8.8.8')
e2.place(x=470, y=203)
Label(f5, text="Eg:", font=("Arial", 9)).place(x=445, y=263)
e3 = Entry(f5, width=30)
e3.insert(0, '8.8.8.8')
